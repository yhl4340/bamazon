...
//       }
//     ])
//     .then(function(goBackCheck) {
//       if (goBackCheck.goBack == true) {
//         menuOpt();
//       } else {
//         connection.end();
//       }
            ...
            function(res) {
              ...
              console.log(
                ans.num +
                  ...
                  " has been added! The new total remaining is " +
                  newQty
              );
        ...
        function(err, resp) {
          ...
          inquirer
            ...
            .then(function(reply) {
              ...
              if (reply.toAdd == true) {
                console.log(
                  "Item has been successfully added. You are now in the main page"
                );
                viewProducts();
                menuOpt();
              } else {
